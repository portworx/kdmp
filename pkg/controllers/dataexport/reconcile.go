...
const (
	...
	// pvcNameLenLimit is the max lenght of PVC name that DataExport related CRs
...
func (c *Controller) stageSnapshotScheduled(ctx context.Context, dataExport *kdmpapi.DataExport) (bool, error) {
	...
	/*_, err = snapshotDriver.SnapshotStatus(snapName, dataExport.Spec.Source.Namespace)
	if err == nil {
		// snapshot already scheduled
		return false, nil
	}*/
