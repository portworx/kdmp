...
func (in *BackupLocationMaintenanceStatus) DeepCopyInto(out *BackupLocationMaintenanceStatus) {
	*out = *in
	if in.FullMaintenacneRepoStatus != nil {
		in, out := &in.FullMaintenacneRepoStatus, &out.FullMaintenacneRepoStatus
		*out = make(map[string]RepoMaintenanceStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	if in.QuickMaintenacneRepoStatus != nil {
		in, out := &in.QuickMaintenacneRepoStatus, &out.QuickMaintenacneRepoStatus
		*out = make(map[string]RepoMaintenanceStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
