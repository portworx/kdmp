...
require (
	...
	github.com/libopenstorage/stork v1.4.1-0.20230227033437-2d261ddf9bcf
...
replace (
	...
	github.com/kubernetes-incubator/external-storage v0.0.0-00010101000000-000000000000 => github.com/libopenstorage/external-storage v0.25.1-openstorage-rc1
